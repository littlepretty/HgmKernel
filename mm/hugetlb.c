...
retry:
	...
	subpage = calculate_subpage(h, page, haddr_hgm);
 ...
 *  - SPLIT_NEVER   - Never split.
 *  - SPLIT_NONE    - Split empty PTEs.
 *  - SPLIT_PRESENT - Split present PTEs.
 *  - SPLIT_ALWAYS  - Split both empty and present PTEs.
 */
